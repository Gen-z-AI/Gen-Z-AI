...
const Prompt = () => {
  ...
  useEffect(() => {
    if (answer !== "" && question !== "") {
      ...
      if (
        lowercaseQuestion === "who are you?" || // Include the question mark
        lowercaseQuestion === "who are you" || // Include the question mark
        lowercaseQuestion === "what is gen-z-ai?"||
        lowercaseQuestion === "what is gen-z-ai"||
        ...
        setChatHistory([
          {
            question,
            answer:
              lowercaseQuestion === "who are you?" || lowercaseQuestion === "who are you" ||lowercaseQuestion === "what is gen-z-ai?" ||lowercaseQuestion === "what is gen-z-ai" ? (
                <>
                  <p>I am a Gen-Z AI, how can I help you as an AI assistant? I have been created by Rajan, Priyanshi, and Druti. I am a Gen-Z AI ready to assist you with anything you need. Let's get started!</p>
                  <div class="flex items-center gap-5 px-12">
                    <img class="h-12 w-12 relative shrink-0 left-6 rounded-full ring-2 ring-white inline-block transition-transform duration-300 transform hover:scale-110" src="https://readymadeui.com/team-4.webp" alt="avatar" />
                    ...
                    <img class="h-12 w-12 relative shrink-0 right-6 rounded-full ring-2 ring-white inline-block transition-transform duration-300 transform hover:scale-110" src="https://readymadeui.com/team-3.webp" alt="avatar" />
                  </div>
                </>
              ) : lowercaseQuestion === "how are you" ? (
                <>
